...
public class DescendenteAltaBubble extends Thread {
    ...
    public DescendenteAltaBubble(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame frame) {
    ...
    public ChartPanel crearChart(double myArray[]) {
        ...
        try {
            ImageIO.write(image, "png", new File("DescendenteAltaBubble.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "DescendenteAltaBubble.html";
        ...
        try {
            ...
            archivo2.write("<div align=\"center\"><img src=\"DescendenteAltaBubble.png\"></div>");
