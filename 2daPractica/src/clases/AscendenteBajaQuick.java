...
public class AscendenteBajaQuick extends Thread{
    ...
    public AscendenteBajaQuick(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame ventana) {
    ...
    public ChartPanel crearChart(double arregloDeNumeros[]) {
        ...
        try {
            ImageIO.write(image, "png", new File("AscendenteBajaQuick.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "AscendenteBajaQuick.html";
        ...
        try {
            ...
            archivo2.write("<div align=\"center\"><img src=\"AscendenteBajaQuick.png\"></div>");
