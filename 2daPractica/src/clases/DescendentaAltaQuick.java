...
public class DescendentaAltaQuick extends Thread{
    ...
    public DescendentaAltaQuick(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame ventana) {
    ...
    public ChartPanel crearChart(double arregloDeNumeros[]) {
        ...
        try {
            ImageIO.write(image, "png", new File("DescendenteAltaQuick.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "DescendenteAltaQuick.html";
        ...
        try {
            ...
            archivo2.write("<div align=\"center\"><img src=\"DescendenteAltaQuick.png\"></div>");
