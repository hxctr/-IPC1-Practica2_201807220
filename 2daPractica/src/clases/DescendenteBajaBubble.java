...
public class DescendenteBajaBubble extends Thread{
    ...
    public DescendenteBajaBubble(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame frame) {
    ...
    public ChartPanel crearChart(double myArray[]) {
        ...
        try {
            ImageIO.write(image, "png", new File("DescendenteBajaBubble.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "DescendenteBajaBubble.html";
        ...
        try {
            ...
            archivo2.write("<div align=\"center\"><img src=\"DescendenteBajaBubble.png\"></div>");
