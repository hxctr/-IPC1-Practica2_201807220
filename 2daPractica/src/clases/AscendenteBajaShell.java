...
public class AscendenteBajaShell extends Thread {
    ...
    public AscendenteBajaShell(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame ventana) {
    ...
    public ChartPanel crearChart(double arregloDeNumeros[]) {
        ...
        try {
            ImageIO.write(image, "png", new File("AscendenteBajaShell.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "AscendenteBajaShell.html";
        ...
        try {
            ...
            archivo2.write("<div align=\"center\"><img src=\"AscendenteBajaShell.png\"></div>");
