...
public class DescendenteMediaQuick extends Thread{
    ...
    public DescendenteMediaQuick(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame ventana) {
    ...
    public ChartPanel crearChart(double arregloDeNumeros[]) {
        ...
        try {
            ImageIO.write(image, "png", new File("DescendenteMediaQuick.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "DescendenteMediaQuick.html";
        ...
        try {
            ...
            archivo2.write("<div align=\"center\"><img src=\"DescendenteMediaQuick.png\"></div>");
