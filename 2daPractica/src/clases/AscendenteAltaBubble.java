...
public class AscendenteAltaBubble extends Thread {
    ...
    public AscendenteAltaBubble(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame frame) {
    ...
    private CategoryDataset crearConjuntoDeDatos(double arreglo[]) {
        final String safety = "safety";
        final DefaultCategoryDataset dataset =
                new DefaultCategoryDataset();

        for (int i = 1; i < cantFilas1; i++) {
            dataset.addValue(arreglo[i], vectorString[i], vectorString[i]);
        }
        return dataset;
    }

    public ChartPanel crearChart(double arreglo[]) {
        JFreeChart barChart = ChartFactory.createBarChart(VentanaPrincipal.txtGrafica.getText(), VentanaPrincipal.vectorString[0], VentanaPrincipal.vectorSegundaColumna[0], crearConjuntoDeDatos(arreglo), PlotOrientation.VERTICAL, true, true, false);
        ...
        try {
            ImageIO.write(image, "png", new File("AscendenteAltaBubble.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "AscendenteAltaBubble.html";
        ...
        try {
            ...
            archivo2.write("<!DOCTYPE html>\n"
                    ...
                    + "<h3><font color=\"white\">Velocidad: Alta</font></h3>\n"
            ...
            archivo2.write("<div align=\"center\"><img src=\"AscendenteAltaBubble.png\"></div>");
