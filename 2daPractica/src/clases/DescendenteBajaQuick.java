...
public class DescendenteBajaQuick extends Thread{
    ...
    public DescendenteBajaQuick(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame ventana) {
    ...
    public ChartPanel crearChart(double arregloDeNumeros[]) {
        ...
        try {
            ImageIO.write(image, "png", new File("DescendenteBajaQuick.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "DescendenteBajaQuick.html";
        ...
        try {
            ...
            archivo2.write("<!DOCTYPE html>\n"
                    ...
                    + "<hr>\n"
                    + "<hr>\n"
                    + "<h3><font color=\"white\">Algoritmo: Quicksort</font></h3>\n"
                    ...
                    + "<h3><font color=\"white\">Pasos: "+(contadorPasos-9)+"</font></h3>\n");
            //-----------------------------------------------------------------------------------
            ...
            archivo2.write("<div align=\"center\"><img src=\"DescendenteBajaQuick.png\"></div>");
