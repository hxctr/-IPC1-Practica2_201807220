...
public class AscendenteAltaQuick extends Thread{
    ...
    public AscendenteAltaQuick(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame ventana) {
    ...
    public ChartPanel crearChart(double arregloDeNumeros[]) {
        ...
        try {
            ImageIO.write(image, "png", new File("AscendenteAltaQuick.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "AscendenteAltaQuick.html";
        ...
        try {
            ...
            archivo2.write("<div align=\"center\"><img src=\"AscendenteAltaQuick.png\"></div>");
