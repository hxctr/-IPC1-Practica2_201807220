...
public class DescendenteMediaShell extends Thread{
    ...
    public DescendenteMediaShell(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame ventana) {
    ...
    public ChartPanel crearChart(double arregloDeNumeros[]) {
        ...
        try {
            ImageIO.write(image, "png", new File("DescendenteMediaShell.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "DescendenteMediaShell.html";
        ...
        try {
            ...
            archivo2.write("<div align=\"center\"><img src=\"DescendenteMediaShell.png\"></div>");
