...
public class AscendenteAltaShell extends Thread{
    ...
    public AscendenteAltaShell(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame ventana) {
    ...
    public ChartPanel crearChart(double arregloDeNumeros[]) {
        ...
        try {
            ImageIO.write(image, "png", new File("AscendenteAltaShell.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "AscendenteAltaShell.html";
        ...
        try {
            ...
            archivo2.write("<div align=\"center\"><img src=\"AscendenteAltaShell.png\"></div>");
