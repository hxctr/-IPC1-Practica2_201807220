...
public class DescendenteBajaShell extends Thread{
    ...
    public DescendenteBajaShell(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame ventana) {
    ...
    public ChartPanel crearChart(double arregloDeNumeros[]) {
        ...
        try {
            ImageIO.write(image, "png", new File("DescendenteBajaShell.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "DescendenteBajaShell.html";
        ...
        try {
            ...
            archivo2.write("<div align=\"center\"><img src=\"DescendenteBajaShell.png\"></div>");
