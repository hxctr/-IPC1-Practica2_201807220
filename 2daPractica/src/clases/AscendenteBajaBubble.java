...
public class AscendenteBajaBubble extends Thread {
    ...
    public AscendenteBajaBubble(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame frame) {
    ...
    public ChartPanel crearChart(double myArray[]) {
        JFreeChart barChart = ChartFactory.createBarChart(VentanaPrincipal.txtGrafica.getText(), VentanaPrincipal.vectorString[0], vectorSegundaColumna[0], crearConjuntoDeDatos(myArray), PlotOrientation.VERTICAL, true, true, false);
        ...
        try {
            ImageIO.write(image, "png", new File("ABB_Ordenada.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    /*public void genearReporte(double segundosTotales){
        Reportes RP = new Reportes("Bubble Sort", "Media", "Ascendente", segundosTotales, contadorPasos, VentanaPrincipal.vectorDouble, VentanaPrincipal.vectorPrimeraColumna, VentanaPrincipal.vectorSegundaColumna, VentanaPrincipal.filasTotales );
        RP.generarVector();
    }*/
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "AscendenteBajaBubble.html";
        ...
        try {
            ...
            archivo2.write("<!DOCTYPE html>\n"
                    ...
                    + "<h3><font color=\"white\">Velocidad: Baja</font></h3>\n"
            ...
            archivo2.write("<div align=\"center\"><img src=\"ABB_Ordenada.png\"></div>");
    ...
    public static void printMatriz(String[][] mat) {//Metodo con el cual imprimiria la matriz

        System.out.println("mostrando la matriz de datos desordenados");
