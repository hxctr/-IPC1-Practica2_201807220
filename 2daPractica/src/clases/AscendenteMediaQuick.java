...
public class AscendenteMediaQuick extends Thread{
    ...
    public AscendenteMediaQuick(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame ventana) {
    ...
    public ChartPanel crearChart(double arregloDeNumeros[]) {
        ...
        try {
            ImageIO.write(image, "png", new File("AscendenteMediaQuick.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "AscendenteMediaQuick.html";
        ...
        try {
            ...
            archivo2.write("<div align=\"center\"><img src=\"AscendenteMediaQuick.png\"></div>");
