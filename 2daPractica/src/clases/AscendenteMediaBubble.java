...
public class AscendenteMediaBubble extends Thread{
    ...
    public AscendenteMediaBubble(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame frame) {
    ...
    public ChartPanel crearChart(double myArray[]) {
        ...
        try {
            ImageIO.write(image, "png", new File("AscendenteMediaBubble.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "AscendenteMediaBubble.html";
        ...
        try {
            ...
            archivo2.write("<div align=\"center\"><img src=\"AscendenteMediaBubble.png\"></div>");
