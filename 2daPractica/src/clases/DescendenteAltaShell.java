...
public class DescendenteAltaShell extends Thread{
    ...
    public DescendenteAltaShell(double[] vectorDouble, String[] vectorString, int cantFilas1, JFrame ventana) {
    ...
    public ChartPanel crearChart(double arregloDeNumeros[]) {
        ...
        try {
            ImageIO.write(image, "png", new File("DescendenteAltaShell.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//----------------------------------------------------------------------------------------------------------------------
        String rutaReporte = "DescendenteAltaShell.html";
        ...
        try {
            ...
            archivo2.write("<!DOCTYPE html>\n"
                    ...
                    + "<hr>\n"
                    + "<hr>\n"
                    + "<h3><font color=\"white\">Algoritmo: Shellsort Sort</font></h3>\n"
            ...
            archivo2.write("<div align=\"center\"><img src=\"DescendenteAltaShell.png\"></div>");
